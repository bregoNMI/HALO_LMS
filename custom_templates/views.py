        ...
        try:
            ...
            if form.is_valid():
                ...
                if data['layout'] == 'layout2':
                    Widget.objects.create(dashboard=dashboard, type='resumeCourses', widget_title='Nothing in progress... yet.', widget_title_color='#41454d', widget_subtext='View My Courses', widget_subtext_color='#798292', widget_icon='fa-light fa-play', widget_icon_color='#8a2be2', widget_icon_background_color='#e5caff', widget_external_link=None)
                    Widget.objects.create(dashboard=dashboard, type='myCourses', widget_title='My Courses', widget_title_color='#41454d', widget_subtext='See courses you are enrolled in', widget_subtext_color='#798292', widget_icon='fa-light fa-book-open-cover', widget_icon_color='#dc6618', widget_icon_background_color='#ffbf7c', widget_external_link=None)
                    Widget.objects.create(dashboard=dashboard, type='enrollmentKey', widget_title='Enrollment Key', widget_title_color='#41454d', widget_subtext='Have an Enrollment Key?', widget_subtext_color='#798292', widget_icon='fa-light fa-key', widget_icon_color='#059f48', widget_icon_background_color='#b3ecb3', widget_external_link=None)
                    Widget.objects.create(dashboard=dashboard, type='externalLink', widget_title='External Link', widget_title_color='#41454d', widget_subtext='Link to an external source', widget_subtext_color='#798292', widget_icon='fa-light fa-link', widget_icon_color='#1863dc', widget_icon_background_color='#d0e0ff', widget_external_link=None)
