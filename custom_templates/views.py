        ...
        try:
            ...
            if form.is_valid():
                ...
                if data['layout'] == 'layout2':
                    ...
                    Widget.objects.create(dashboard=dashboard, type='enrollmentKey', widget_title='Enrollment Key', widget_title_color='#41454d', widget_subtext='Have an Enrollment Key?', widget_subtext_color='#6b6b6b', widget_icon='fa-light fa-key', widget_icon_color='#059f48', widget_icon_background_color='#b3ecb3', widget_external_link=None)
