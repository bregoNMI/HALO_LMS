...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='courses',
            field=models.ManyToManyField(blank=True, related_name='enrollment_keys', to='content.course'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='facialverificationlog',
            name='lesson',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='content.lesson'),
        ),
        migrations.AddField(
            model_name='facialverificationlog',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='OrganizationSettings', to='client_admin.allowedidphotos'),
        ),
        migrations.AddField(
            model_name='profile',
        ...
        migrations.AddField(
            ...
            name='assignment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='content.upload'),
        ),
        migrations.AddField(
            model_name='userassignmentprogress',
            name='course',
        ...
        migrations.AddField(
            model_name='generatedcertificate',
            name='user_course',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='certificates', to='client_admin.usercourse'),
        ),
        migrations.AddField(
            model_name='facialverificationlog',
            name='user_course',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='client_admin.usercourse'),
        ),
        migrations.AddField(
