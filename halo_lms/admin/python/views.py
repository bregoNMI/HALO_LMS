...
def admin_users(request):
    ...
    users_list = User.objects.filter(query).order_by(order_by_field)
...
def user_details(request, user_id):
    ...
    return render(request, 'admin/html/users/user_details.html', context)
=======
=======
from django.contrib.auth.decorators import login_required
from django.contrib.auth.models import User
...
>>>>>>> b83779d0773e6480e140931db1196406a7317ef1
