...
// LMSInitialize function implementation
    pipwerks.SCORM.connection.initialize = function() {
        ...
        if (!scorm.connection.isActive) {
            ...
            if (API) {
                // Correct initialization method for SCORM 1.2 or 2004
                if (scorm.version === "1.2" && typeof API.LMSInitialize === "function") {
                    success = makeBoolean(API.LMSInitialize(""));
                } else if (scorm.version === "2004" && typeof API.Initialize === "function") {
                    success = makeBoolean(API.Initialize(""));
                } else {
                    console.error("Correct SCORM initialization method not found on API object.");
                    return false;
                }
